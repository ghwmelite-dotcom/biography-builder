...
export const defaultOrderOfService = {
  churchService: [
    { time: '8:30 AM', description: 'Arrival of Body & Seating of Family' },
    { time: '8:40 AM', description: 'Opening Hymn — Congregation' },
    { time: '8:50 AM', description: "Opening Prayer & Apostles' Creed" },
    { time: '9:00 AM', description: 'First Scripture Reading — Old Testament' },
    { time: '9:10 AM', description: 'Hymn — Choir' },
    { time: '9:20 AM', description: 'Second Scripture Reading — New Testament' },
    { time: '9:30 AM', description: 'Biography of the Deceased' },
    { time: '9:50 AM', description: 'Tribute by Children' },
    { time: '10:05 AM', description: 'Tribute by Grandchildren' },
    { time: '10:15 AM', description: 'Tribute by Family' },
    { time: '10:30 AM', description: 'Tribute by Friends & Colleagues' },
    { time: '10:45 AM', description: 'Musical Selection — Church Choir' },
    { time: '10:55 AM', description: 'Sermon — Officiating Minister' },
    { time: '11:20 AM', description: 'Hymn — Congregation' },
    { time: '11:30 AM', description: 'Prayers for the Family' },
    { time: '11:40 AM', description: 'Offertory' },
    { time: '11:45 AM', description: 'Closing Hymn' },
    { time: '11:50 AM', description: 'Benediction' },
    { time: '11:55 AM', description: 'Filing Past the Remains' },
    { time: '12:00 PM', description: 'Vote of Thanks & Announcements' },
  ],
  privateBurial: [
    { time: '', description: 'Delegation Departs with Body' },
