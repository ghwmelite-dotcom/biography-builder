export const defaultScriptures = {
  ...
  '1thessalonians4': {
    ...
    subtitle: 'The Coming of the Lord',
...
export const defaultOrderOfService = {
  churchService: [
    ...
    { time: '8:50 AM', description: 'Hymn I — When I Survey' },
    { time: '8:55 AM', description: 'Invocation / Opening Prayer' },
    { time: '9:00 AM', description: 'Scripture Reading I (1 Thessalonians 4:13-18)' },
    { time: '9:05 AM', description: 'Scripture Reading II (1 Corinthians 15:51-58)' },
    { time: '9:10 AM', description: 'Hymn II — Because He Lives' },
    ...
    { time: '10:30 AM', description: 'Sermon' },
    { time: '10:40 AM', description: 'Offertory for Family — Song II (Special Ministration)' },
    { time: '10:50 AM', description: 'Altar Call / Closing Prayer' },
    { time: '10:55 AM', description: 'Hymn III — When Peace Like a River' },
