...
export function createStyles(theme) {
  return StyleSheet.create({
    ...
    subheading: {
      fontFamily: 'Cormorant', fontSize: 14, color: theme.subtleText,
      textAlign: 'center', fontStyle: 'italic', marginBottom: 12,
    },
    bodyText: {
      fontFamily: 'EBGaramond', fontSize: 11, color: theme.bodyText,
      lineHeight: 1.7, textAlign: 'justify',
    },
    bodyParagraph: {
      fontFamily: 'EBGaramond', fontSize: 11, color: theme.bodyText,
      lineHeight: 1.7, textAlign: 'justify', marginBottom: 8,
    },
    coverTitle: {
    ...
    coverSubtitle: {
      fontFamily: 'Cormorant', fontStyle: 'italic', fontSize: 16,
      color: theme.subtleText, textAlign: 'center', marginTop: 2,
    },
    coverName: {
      fontFamily: 'Playfair', fontWeight: 700, fontSize: 24,
      color: theme.heading, textAlign: 'center',
      letterSpacing: 3, textTransform: 'uppercase', lineHeight: 1.4,
    },
    coverDates: {
      fontFamily: 'Cormorant', fontSize: 13, color: theme.subtleText,
      textAlign: 'center', letterSpacing: 1,
    },
    coverVerse: {
      fontFamily: 'EBGaramond', fontStyle: 'italic', fontSize: 10,
      color: theme.subtleText, textAlign: 'center', lineHeight: 1.6,
    },
    coverVenue: {
      fontFamily: 'Cormorant', fontSize: 10, color: theme.subtleText,
      textAlign: 'center', letterSpacing: 0.5,
    },
    verseText: {
      fontFamily: 'EBGaramond', fontStyle: 'italic', fontSize: 12,
      color: theme.subtleText, textAlign: 'center', lineHeight: 1.8, marginBottom: 6,
    },
    verseRef: {
      fontFamily: 'Playfair', fontSize: 9, color: theme.heading,
      textAlign: 'center', letterSpacing: 1,
    },
    serviceRow: {
      flexDirection: 'row', paddingVertical: 4,
      borderBottomWidth: 0.5, borderBottomColor: theme.border,
      borderBottomStyle: 'solid', opacity: 0.3,
    },
    serviceTime: {
      fontFamily: 'Playfair', fontWeight: 700, fontSize: 10,
      color: theme.heading, width: 80,
    },
    serviceDesc: {
      fontFamily: 'EBGaramond', fontSize: 11, color: theme.subtleText, flex: 1,
    },
    sectionLabel: {
      fontFamily: 'Playfair', fontWeight: 700, fontSize: 11,
      color: theme.heading, textTransform: 'uppercase',
      letterSpacing: 3, marginTop: 14, marginBottom: 6,
    },
    photoPlaceholder: {
    ...
    photoCaption: {
      fontFamily: 'Cormorant', fontStyle: 'italic', fontSize: 9,
      color: theme.subtleText, textAlign: 'center', marginTop: 4,
    },
    officialRole: {
      fontFamily: 'Playfair', fontSize: 10, color: theme.heading,
      textAlign: 'center', textTransform: 'uppercase',
      letterSpacing: 2, marginTop: 10,
    },
    officialName: {
      fontFamily: 'EBGaramond', fontSize: 12, color: theme.subtleText,
      textAlign: 'center', marginTop: 2,
    },
    ackSignature: {
      fontFamily: 'Playfair', fontWeight: 700, fontSize: 14,
      color: theme.heading, textAlign: 'center', marginTop: 16,
    },
    pageNumber: {
